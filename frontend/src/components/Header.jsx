export default function Header() {
  return (
    <div className="p-8 flex flex-col items-center  from-gray-900 via-gray-800 to-gray-700 text-gray-100">
      <h1 className="flex items-center text-5xl font-semibold text-indigo-300 mb-6">
